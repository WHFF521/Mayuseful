...
![anaconda prompt](anacondaprompt.jpg)
打开后会看见类似于这样的一行
...
![condainfoe](condainfov.jpg)
使用`conda activate py37ten115`激活虚拟环境
![condaactivate](condaactivate.jpg)
